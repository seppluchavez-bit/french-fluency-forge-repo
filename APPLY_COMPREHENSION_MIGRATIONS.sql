-- ============================================================================
-- Comprehension Items Migrations
-- ============================================================================
...
-- Migration 1: Create comprehension_items table
-- ============================================================================
...
-- ============================================================================
-- Migration 2: Seed comprehension items data
-- ============================================================================
...
--        COUNT(audio_url) as items_with_audio,
--        cefr_level,
...
-- ORDER BY cefr_level;
-- 
-- Expected result: 12 total items (2 A1, 5 A2, 3 B1, 2 B2), all with audio_url = NULL initially
-- ============================================================================
